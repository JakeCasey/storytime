var submit = require('../routes/submitRoute.js');
...
describe('submit', () => {
   describe('/POST text', () => {
      it('should POST text and split that text into an array of strings that are 1500 characters or less', (done) => {
         chai.request(app)
        .post('/submit')
        .send({text: text})
        .end((err, res) => {
   ...
   // describe('/POST text', () => {
      // it('should POST text and create an audio file with the appropriate id', (done) => {
      // var text = {text: 'hello world'}
          ...
          // .end((err, res) => {
            ...
            // id = res.body.id
            // expect('../audio/'+ id + '.mp3').to.be.a.file();
            // done()
          // });
      // });
